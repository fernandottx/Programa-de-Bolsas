...
# A função calcula a média dos preços dos produtos e retorna apenas os 
# que estão acima da média usando 'filter' e 'lambda' de forma crescente usando o 'sorted'.
