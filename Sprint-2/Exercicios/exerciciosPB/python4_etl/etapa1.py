...
# Usa a função max() para encontrar o ator com maior valor na chave "number_of_movies" 
# (quantidade de filmes).
ator_maiorNum_filmes = max(dados_atores, key=lambda actor: actor["number_of_movies"])

# Mensagem formatada
print(
    f'O ator que mais possui filmes no dataset é {ator_maiorNum_filmes["actor"]} '
    f'com {ator_maiorNum_filmes["number_of_movies"]} filmes.'
)
